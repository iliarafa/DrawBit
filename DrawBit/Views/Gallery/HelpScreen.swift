...
struct HelpScreen: View {
    ...
    private static let topics: [HelpTopic] = [
        ...
        HelpTopic(id: "Help.section.export", icon: .shareGlyph, title: "EXPORT",
                  body: "PNG: one still frame. GIF: animation, plays anywhere but only 256 colors. APNG: animation in full color. Sprite: every frame in one image. Then pick a scale and share."),
