...
struct HelpScreen: View {
    ...
    private static let topics: [HelpTopic] = [
        ...
        HelpTopic(id: "Help.section.trace", icon: .pixel(Self.traceImage), title: "TRACE",
                  body: "Add a photo to trace over from the foot of the Layers panel. It sits dimmed behind your pixels — set its fade, hide it, or remove it any time. The pick tool reads its colors through blank pixels. It never appears in exports."),
        ...
        HelpTopic(id: "Help.section.export", icon: .shareGlyph, title: "EXPORT",
                  body: "PNG: one still frame. GIF: animation, plays anywhere but only 256 colors. APNG: animation in full color. Sprite: every frame in one image. FILM: your draw painting itself, start to finish. Then pick a scale and share."),
