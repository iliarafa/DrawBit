...
**Spec:** [docs/superpowers/specs/2026-04-19-drawbit-design.md](../specs/2026-04-19-drawbit-design.md)

**Working dir:** `/Users/iliasrafailidis/drawbit`
  ...
  DrawBitTests:
    ...
    settings:
      base:
        ...
        TEST_HOST: "$(BUILT_PRODUCTS_DIR)/DrawBit.app/DrawBit"
  DrawBitUITests:
...
Run:
```bash
mkdir -p DrawBit DrawBitTests DrawBitUITests
touch DrawBit/.gitkeep DrawBitTests/.gitkeep DrawBitUITests/.gitkeep
```

- [ ] **Step 4: Commit**

```bash
git add project.yml DrawBit/.gitkeep DrawBitTests/.gitkeep DrawBitUITests/.gitkeep
...
**Files:**
- Create: `DrawBit/DrawBitApp.swift`
- Create: `DrawBitTests/SmokeTest.swift`
- Modify: `.gitignore` (add `DrawBit.xcodeproj/`)

- [ ] **Step 1: Write a minimal `DrawBitApp.swift`**

File: `DrawBit/DrawBitApp.swift`
```swift
import SwiftUI
...
Run: `rm DrawBitTests/.gitkeep`

- [ ] **Step 3: Add `DrawBit.xcodeproj/` to `.gitignore`**
...
Expected: prints `Loaded project:` and `Created project at DrawBit.xcodeproj`.

- [ ] **Step 5: Build for iPad Pro (13-inch) simulator**

Run:
```bash
xcodebuild -project DrawBit.xcodeproj -scheme DrawBit -destination 'platform=iOS Simulator,name=iPad Pro 13-inch (M5)' -configuration Debug build | tail -20
```
...
Run:
```bash
xcodebuild -project DrawBit.xcodeproj -scheme DrawBit -destination 'platform=iOS Simulator,name=iPad Pro 13-inch (M5)' test | tail -20
```
...
```bash
git add DrawBit DrawBitTests DrawBitUITests .gitignore
git rm -f --ignore-unmatch DrawBit/.gitkeep DrawBitTests/.gitkeep DrawBitUITests/.gitkeep 2>/dev/null || true
...
**Files:**
- Create: `DrawBit/Models/CanvasSize.swift`
- Create: `DrawBitTests/Models/CanvasSizeTests.swift`

- [ ] **Step 1: Write the failing test**

File: `DrawBitTests/Models/CanvasSizeTests.swift`
```swift
import XCTest
...
File: `DrawBit/Models/CanvasSize.swift`
```swift
import Foundation
...
Run: `xcodegen generate && xcodebuild -project DrawBit.xcodeproj -scheme DrawBit -destination 'platform=iOS Simulator,name=iPad Pro 13-inch (M5)' test | tail -5`
Expected: `** TEST SUCCEEDED **`.

- [ ] **Step 5: Commit**

```bash
git add DrawBit/Models/CanvasSize.swift DrawBitTests/Models/CanvasSizeTests.swift
...
**Files:**
- Create: `DrawBit/Models/Tool.swift`
- Create: `DrawBitTests/Models/ToolTests.swift`

- [ ] **Step 1: Write the failing test**

File: `DrawBitTests/Models/ToolTests.swift`
```swift
import XCTest
@testable import DrawBit
...
File: `DrawBit/Models/Tool.swift`
```swift
import Foundation
...
Run: `xcodegen generate && xcodebuild test -project DrawBit.xcodeproj -scheme DrawBit -destination 'platform=iOS Simulator,name=iPad Pro 13-inch (M5)' | tail -5`

- [ ] **Step 5: Commit**

```bash
git add DrawBit/Models/Tool.swift DrawBitTests/Models/ToolTests.swift
...
**Files:**
- Create: `DrawBit/Models/Piece.swift`
- Create: `DrawBitTests/Models/PieceTests.swift`

- [ ] **Step 1: Write failing tests**

File: `DrawBitTests/Models/PieceTests.swift`
```swift
import XCTest
import SwiftData
@testable import DrawBit
...
File: `DrawBit/Models/Piece.swift`
```swift
import Foundation
import SwiftData
...
**Files:**
- Create: `DrawBit/Models/AppSettings.swift`
- Create: `DrawBitTests/Models/AppSettingsTests.swift`

- [ ] **Step 1: Write failing tests**

File: `DrawBitTests/Models/AppSettingsTests.swift`
```swift
import XCTest
@testable import DrawBit
...
File: `DrawBit/Models/AppSettings.swift`
```swift
import Foundation
import SwiftData
...
```bash
git add DrawBit/Models/AppSettings.swift DrawBitTests/Models/AppSettingsTests.swift
...
**Files:**
- Create: `DrawBit/Drawing/PixelGrid.swift`
- Create: `DrawBitTests/Drawing/PixelGridTests.swift`
...
File: `DrawBitTests/Drawing/PixelGridTests.swift`
```swift
import XCTest
@testable import DrawBit
...
File: `DrawBit/Drawing/PixelGrid.swift`
```swift
import Foundation
...
```bash
git add DrawBit/Drawing/PixelGrid.swift DrawBitTests/Drawing/PixelGridTests.swift
...
**Files:**
- Create: `DrawBit/Drawing/BresenhamLine.swift`
- Create: `DrawBitTests/Drawing/BresenhamLineTests.swift`

- [ ] **Step 1: Write failing tests**

File: `DrawBitTests/Drawing/BresenhamLineTests.swift`
```swift
import XCTest
@testable import DrawBit
...
File: `DrawBit/Drawing/BresenhamLine.swift`
```swift
import Foundation
...
```bash
git add DrawBit/Drawing/BresenhamLine.swift DrawBitTests/Drawing/BresenhamLineTests.swift
...
**Files:**
- Create: `DrawBit/Drawing/Pencil.swift`
- Create: `DrawBitTests/Drawing/PencilTests.swift`

- [ ] **Step 1: Write failing tests**

File: `DrawBitTests/Drawing/PencilTests.swift`
```swift
import XCTest
@testable import DrawBit
...
File: `DrawBit/Drawing/Pencil.swift`
```swift
import Foundation
...
```bash
git add DrawBit/Drawing/Pencil.swift DrawBitTests/Drawing/PencilTests.swift
...
**Files:**
- Create: `DrawBit/Drawing/Eraser.swift`
- Create: `DrawBitTests/Drawing/EraserTests.swift`

- [ ] **Step 1: Write failing tests**

File: `DrawBitTests/Drawing/EraserTests.swift`
```swift
import XCTest
@testable import DrawBit
...
File: `DrawBit/Drawing/Eraser.swift`
```swift
import Foundation
...
```bash
git add DrawBit/Drawing/Eraser.swift DrawBitTests/Drawing/EraserTests.swift
...
**Files:**
- Create: `DrawBit/Drawing/Fill.swift`
- Create: `DrawBitTests/Drawing/FillTests.swift`

- [ ] **Step 1: Write failing tests**

File: `DrawBitTests/Drawing/FillTests.swift`
```swift
import XCTest
@testable import DrawBit
...
File: `DrawBit/Drawing/Fill.swift`
```swift
import Foundation
...
```bash
git add DrawBit/Drawing/Fill.swift DrawBitTests/Drawing/FillTests.swift
...
**Files:**
- Create: `DrawBit/Drawing/Eyedropper.swift`
- Create: `DrawBitTests/Drawing/EyedropperTests.swift`

- [ ] **Step 1: Write failing tests**

File: `DrawBitTests/Drawing/EyedropperTests.swift`
```swift
import XCTest
@testable import DrawBit
...
File: `DrawBit/Drawing/Eyedropper.swift`
```swift
import Foundation
...
```bash
git add DrawBit/Drawing/Eyedropper.swift DrawBitTests/Drawing/EyedropperTests.swift
...
**Files:**
- Create: `DrawBit/Rendering/PixelsToCGImage.swift`
- Create: `DrawBitTests/Rendering/PixelsToCGImageTests.swift`

- [ ] **Step 1: Write failing tests**

File: `DrawBitTests/Rendering/PixelsToCGImageTests.swift`
```swift
import XCTest
import CoreGraphics
@testable import DrawBit
...
File: `DrawBit/Rendering/PixelsToCGImage.swift`
```swift
import CoreGraphics
import Foundation
...
```bash
git add DrawBit/Rendering/PixelsToCGImage.swift DrawBitTests/Rendering/PixelsToCGImageTests.swift
...
**Files:**
- Create: `DrawBit/Rendering/ThumbnailRenderer.swift`
- Create: `DrawBitTests/Rendering/ThumbnailRendererTests.swift`

- [ ] **Step 1: Write failing tests**

File: `DrawBitTests/Rendering/ThumbnailRendererTests.swift`
```swift
import XCTest
import ImageIO
@testable import DrawBit
...
File: `DrawBit/Rendering/ThumbnailRenderer.swift`
```swift
import CoreGraphics
import Foundation
import ImageIO
...
**Files:**
- Create: `DrawBit/Rendering/PNGExporter.swift`
- Create: `DrawBitTests/Rendering/PNGExporterTests.swift`

- [ ] **Step 1: Write failing tests**

File: `DrawBitTests/Rendering/PNGExporterTests.swift`
```swift
import XCTest
import ImageIO
@testable import DrawBit
...
File: `DrawBit/Rendering/PNGExporter.swift`
```swift
import CoreGraphics
import Foundation
import ImageIO
...
```bash
git add DrawBit/Rendering/PNGExporter.swift DrawBitTests/Rendering/PNGExporterTests.swift
...
**Files:**
- Create: `DrawBit/Persistence/PieceRepository.swift`
- Create: `DrawBitTests/Persistence/PieceRepositoryTests.swift`

- [ ] **Step 1: Write failing tests**

File: `DrawBitTests/Persistence/PieceRepositoryTests.swift`
```swift
import XCTest
import SwiftData
@testable import DrawBit
...
File: `DrawBit/Persistence/PieceRepository.swift`
```swift
import Foundation
import SwiftData
...
**Files:**
- Create: `DrawBit/State/EditorState.swift`
- Create: `DrawBitTests/State/EditorStateTests.swift`
...
File: `DrawBitTests/State/EditorStateTests.swift`
```swift
import XCTest
@testable import DrawBit
...
File: `DrawBit/State/EditorState.swift`
```swift
import Foundation
import Observation
...
- Create: `DrawBit/Views/Gallery/GalleryView.swift`
...
File: `DrawBit/Views/Gallery/GalleryView.swift`
```swift
import SwiftUI
import SwiftData
...
```bash
xcodegen generate
xcodebuild test -project DrawBit.xcodeproj -scheme DrawBit -destination 'platform=iOS Simulator,name=iPad Pro 13-inch (M5)' | tail -5
```
Expected: `** TEST SUCCEEDED **`.
...
# open -a Simulator
# xcodebuild -project DrawBit.xcodeproj -scheme DrawBit -destination 'platform=iOS Simulator,id=<UUID>' build
# xcrun simctl install <UUID> <path-to-.app>
# xcrun simctl launch <UUID> com.iamilias.drawbit
```
...
```bash
git add DrawBit/DrawBitApp.swift DrawBit/Views/Gallery/GalleryView.swift
...
**Files:**
- Create: `DrawBit/Views/Gallery/PieceThumbnailView.swift`
- Modify: `DrawBit/Views/Gallery/GalleryView.swift`

- [ ] **Step 1: Create the thumbnail view**

File: `DrawBit/Views/Gallery/PieceThumbnailView.swift`
```swift
import SwiftUI
import UIKit
...
```bash
xcodegen generate
xcodebuild build -project DrawBit.xcodeproj -scheme DrawBit -destination 'platform=iOS Simulator,name=iPad Pro 13-inch (M5)' | tail -5
```

- [ ] **Step 4: Commit**

```bash
git add DrawBit/Views/Gallery/PieceThumbnailView.swift DrawBit/Views/Gallery/GalleryView.swift
...
**Files:**
- Create: `DrawBit/Views/Gallery/NewPieceSheet.swift`
- Modify: `DrawBit/Views/Gallery/GalleryView.swift`

- [ ] **Step 1: Create the size-picker sheet**

File: `DrawBit/Views/Gallery/NewPieceSheet.swift`
```swift
import SwiftUI
...
Update `DrawBit/Views/Gallery/GalleryView.swift` — replace the `.sheet` contents and add a selection state for the created piece:
...
```bash
git add DrawBit/Views/Gallery/NewPieceSheet.swift DrawBit/Views/Gallery/GalleryView.swift
...
**Files:**
- Create: `DrawBit/Views/Editor/EditorView.swift`
- Modify: `DrawBit/Views/Gallery/GalleryView.swift` (navigate to real editor)

- [ ] **Step 1: Create EditorView scaffold with top bar and placeholder canvas area**

File: `DrawBit/Views/Editor/EditorView.swift`
```swift
import SwiftUI
import SwiftData
...
```bash
git add DrawBit/Views/Editor/EditorView.swift DrawBit/Views/Gallery/GalleryView.swift
...
**Files:**
- Create: `DrawBit/Views/Editor/CanvasView.swift`
...
File: `DrawBit/Views/Editor/CanvasView.swift`
```swift
import SwiftUI
import UIKit
...
```bash
git add DrawBit/Views/Editor/CanvasView.swift DrawBit/Views/Editor/EditorView.swift
...
**Files:**
- Create: `DrawBit/Gestures/PencilAvailability.swift`
- Create: `DrawBitTests/Gestures/PencilAvailabilityTests.swift`

Observes whether an Apple Pencil is available so the gesture layer can switch input modes.

- [ ] **Step 1: Write tests**

File: `DrawBitTests/Gestures/PencilAvailabilityTests.swift`
```swift
import XCTest
@testable import DrawBit
...
File: `DrawBit/Gestures/PencilAvailability.swift`
```swift
import Foundation
import Observation
#if canImport(UIKit)
...
```bash
git add DrawBit/Gestures/PencilAvailability.swift DrawBitTests/Gestures/PencilAvailabilityTests.swift
...
**Files:**
- Create: `DrawBit/Gestures/CanvasHostView.swift`
- Modify: `DrawBit/Views/Editor/CanvasView.swift`
...
File: `DrawBit/Gestures/CanvasHostView.swift`
```swift
import SwiftUI
import UIKit
...
In `DrawBit/Views/Editor/CanvasView.swift`, replace the whole body to overlay the input layer:
...
```bash
git add DrawBit/Gestures/CanvasHostView.swift DrawBit/Views/Editor/CanvasView.swift DrawBit/Views/Editor/EditorView.swift
...
**Files:**
- Modify: `DrawBit/Gestures/CanvasHostView.swift`
...
```bash
git add DrawBit/Gestures/CanvasHostView.swift
...
**Files:**
- Create: `DrawBit/Views/Editor/ToolBar.swift`
- Modify: `DrawBit/Views/Editor/EditorView.swift`

- [ ] **Step 1: Create the tool bar**

File: `DrawBit/Views/Editor/ToolBar.swift`
```swift
import SwiftUI
...
```bash
git add DrawBit/Views/Editor/ToolBar.swift DrawBit/Views/Editor/EditorView.swift
...
**Files:**
- Create: `DrawBit/Views/Editor/RecentColorsStrip.swift`
- Modify: `DrawBit/Views/Editor/EditorView.swift`

- [ ] **Step 1: Create the strip**

File: `DrawBit/Views/Editor/RecentColorsStrip.swift`
```swift
import SwiftUI
...
```bash
git add DrawBit/Views/Editor/RecentColorsStrip.swift DrawBit/Views/Editor/EditorView.swift
...
**Files:**
- Create: `DrawBit/Views/Editor/ShareSheet.swift`
- Modify: `DrawBit/Views/Editor/EditorView.swift`

- [ ] **Step 1: Create the share sheet**

File: `DrawBit/Views/Editor/ShareSheet.swift`
```swift
import SwiftUI
import UIKit
...
```bash
git add DrawBit/Views/Editor/ShareSheet.swift DrawBit/Views/Editor/EditorView.swift
...
**Files:**
- Create: `DrawBitUITests/HappyPathTests/DrawAndSaveTest.swift`
- Modify: `DrawBit/Views/Gallery/PieceThumbnailView.swift` (add accessibility identifiers)
...
File: `DrawBitUITests/HappyPathTests/DrawAndSaveTest.swift`
```swift
import XCTest
...
```bash
xcodegen generate
xcodebuild test -project DrawBit.xcodeproj -scheme DrawBit -destination 'platform=iOS Simulator,name=iPad Pro 13-inch (M5)' -only-testing:DrawBitUITests | tail -10
```
Expected: `** TEST SUCCEEDED **`.
...
```bash
git add DrawBitUITests/HappyPathTests/DrawAndSaveTest.swift DrawBit/Views/Gallery/PieceThumbnailView.swift DrawBit/Views/Gallery/GalleryView.swift DrawBit/Views/Gallery/NewPieceSheet.swift DrawBit/DrawBitApp.swift
...
Plan complete and saved to `docs/superpowers/plans/2026-04-19-drawbit-implementation.md`.
